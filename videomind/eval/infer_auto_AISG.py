...
def parse_args():
    ...
    parser.add_argument('--pred_path', default='outputs_7b/AISG_pred.csv')
    parser.add_argument('--model_gnd_path', default='model_zoo/VideoMind-7B')
    parser.add_argument('--model_ver_path', default='model_zoo/VideoMind-7B')
    parser.add_argument('--model_pla_path', default='model_zoo/VideoMind-7B')
    parser.add_argument('--model_ans_path')
    parser.add_argument('--question_parquet', default='E:/Benchmark-AllVideos-HQ-Encoded-challenge/data/test-00000-of-00001.parquet')
    parser.add_argument('--video_dir', default='E:/Benchmark-AllVideos-HQ-Encoded-challenge')
...
if __name__ == '__main__':
    ...
    # load question csv
    question_csv = pd.read_parquet(args.question_parquet)
    ...
    dumps_df.to_csv(args.pred_path, index=False)
